...
import { isAtOffice, OFFICE_LOCATION } from "@/config/officeLocation"
...
export function CheckInOutButtons() {
  ...
  const performCheckOut = async (photoData: string) => {
    ...
    try {
      ...
      console.log("[v0] CheckInOutButtons - CheckOut completed, checkOutPhotoData saved:", !!record.checkOutPhotoData)
